...
@Component({
  selector: 'app-entrance-report',
  templateUrl: './entrance-report.component.html',
  styleUrls: ['./entrance-report.component.scss']
})
export class EntranceReportComponent implements OnInit {

  report: IEntranceReport;
  ...
  loadReport() {
    this.reportService.GetEntranceReport(this.fromDate, this.toDate, this.selectedDepartment?.Id )
    .subscribe(report => {
